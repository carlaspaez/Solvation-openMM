...
PBC_SCRIPT="$SCRIPT_DIR/deltaG_PBC_TIP3P-ampli50.py"
SBC_SCRIPT="$SCRIPT_DIR/deltaG_SBC_TIP3P_ampli50.py"
PBC_CLUSTER_OUT="$ROOT_DIR/outputs_PBC_ampli50/cluster"
SBC_CLUSTER_OUT="$ROOT_DIR/outputs_SBC_ampli50/cluster"
...
submit_job() {
    ...
    echo "Submitting ampli50 $method: $mol -> $partition"
...
echo "Submitted ampli50 PBC/SBC jobs."

...
PBC_SCRIPT="$SCRIPT_DIR/deltaG_PBC_TIP3P-ampli10.py"
SBC_SCRIPT="$SCRIPT_DIR/deltaG_SBC_TIP3P_ampli10.py"
PBC_CLUSTER_OUT="$ROOT_DIR/outputs_PBC_ampli10/cluster"
SBC_CLUSTER_OUT="$ROOT_DIR/outputs_SBC_ampli10/cluster"
...
submit_job() {
    ...
    echo "Submitting ampli10 $method: $mol -> $partition"
...
echo "Submitted ampli10 PBC/SBC jobs."

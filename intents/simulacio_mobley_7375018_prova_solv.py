...
OUT_DIR = REPO_DIR / "outputs" / "simulacio_mobley_7375018_prova_solv"   # Carpeta de salida. # CARLA: NO ENTENC PQ EM FA UNA SUBCARPETA DE RESULTATS QUE ES DIU SIMPLE
...
log_path = RESULTS_DIR / "simulacio_mobley_7375018_prova_solv_log.csv"  # CSV de sortida.
...
print("Written", log_path, "and", OUT_DIR / "traj.dcd", "and", pdb_path)  # Informa salidas.
